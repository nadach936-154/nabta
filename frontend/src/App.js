// src/App.js — ✅ VERSION FINALE avec route /parametres
...
// Agriculteur
import DashboardAgriculteur from './pages/agriculteur/DashboardAgriculteur'; // ✅ BUG 2 & 7
import { MesCultures, LivraisonAgriculteur } from './pages/agriculteur/index';
...
// Transporteur
import { DashboardTransporteur, LivraisonsTransporteur, DemandesTransporteur, HistoriqueTransporteur } from './pages/transporteur/index'; // ✅ BUG 6

// Admin
import { DashboardAdmin, Utilisateurs, ProduitsAdmin, Statistiques } from './pages/admin/index'; // ✅ BUG 8
    ...
    <AuthProvider>
      <BrowserRouter future={{ v7_startTransition:true, v7_relativeSplatPath:true }}>
        <Routes>
          ...
          <Route path="/marketplace"   element={<RoutePrivee roles={['agriculteur']}><MarketplaceAgriculteur /></RoutePrivee>} />
          ...
          <Route path="/parametres"  element={<RoutePrivee><Parametres /></RoutePrivee>} /> {/* ✅ BUG 5 */}
